...
public sealed class SpriteSheetManager : ISpriteSheetManager
{
    private readonly ITextureManager _textureManager;

    private readonly IDictionary<string, List<SpriteSheetItem>> _items = new Dictionary<string, List<SpriteSheetItem>>();
