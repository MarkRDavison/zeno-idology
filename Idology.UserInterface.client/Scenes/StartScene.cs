...
internal sealed class StartScene : Scene<StartScene>
{
    ...
    public override void Init(IScenePayload<StartScene>? payload)
    {
...

        {
            ...
            {
                var leftPanel = background.AddChild(new PanelWidget
                {
                    Background = Color.Gray,
                    Border = Color.DarkGray,
                    BorderThickness = 8.0f,
                ...
                var button = leftPanel.AddChild(new TextButtonWidget
                {
                ...
                var button2 = leftPanel.AddChild(new DropdownWidget
                {
                    Foreground = Color.Yellow,
                    Background = Color.Green,
                    Border = Color.DarkBlue,
            ...
            {
                var rightPanel = background.AddChild(new PanelWidget
                {
                    Background = Color.Gray,
                    Border = Color.DarkGray,
                    BorderRoundness = 0.025f,
                ...
                var rightSubPanel1 = rightPanel.AddChild(new PanelWidget
                {
                    Background = Color.Green,
                    Border = Color.DarkGray,
                    BorderRoundness = 0.025f,
                ...
                var rightSubPanel2 = rightPanel.AddChild(new PanelWidget
                {
                    ...
                    Layout = new LayoutItem
                    {
                        RequestedSize = new LayoutVector(256.0f, 500.0f),
                        RequestedMargin = new LayoutEdges(64.0f),
                        Behave = BehaveFlags.Left | BehaveFlags.VCenter,
                        Contain = ContainFlags.Column
                    }
                });
            }
